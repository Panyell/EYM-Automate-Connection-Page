...
WebUI.mouseOver(findTestObject('EYM IO - Connection Page/Traemand/Traemand Sandbox/NetsuiteTokenBased'))

WebUI.delay(2)

WebUI.click(findTestObject('EYM IO - Connection Page/Traemand/Traemand Sandbox/NetsuiteTokenBased'))
