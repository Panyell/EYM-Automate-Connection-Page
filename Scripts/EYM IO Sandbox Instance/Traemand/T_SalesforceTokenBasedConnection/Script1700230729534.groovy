...
WebUI.callTestCase(findTestCase('EYM IO Login/Login Traemand Sandbox'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.mouseOver(findTestObject('EYM IO - Connection Page/Traemand/Traemand Sandbox/SalesforceTokenBased'))

WebUI.delay(2)

WebUI.click(findTestObject('EYM IO - Connection Page/Traemand/Traemand Sandbox/SalesforceTokenBased'))
