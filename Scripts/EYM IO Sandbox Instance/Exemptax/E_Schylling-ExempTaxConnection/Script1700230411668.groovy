...
WebUI.mouseOver(findTestObject('EYM IO - Connection Page/Exemptax/Exemptax Sandbox/Schylling-ExempTax Connection'))

WebUI.delay(2)

WebUI.click(findTestObject('EYM IO - Connection Page/Exemptax/Exemptax Sandbox/Schylling-ExempTax Connection'))
