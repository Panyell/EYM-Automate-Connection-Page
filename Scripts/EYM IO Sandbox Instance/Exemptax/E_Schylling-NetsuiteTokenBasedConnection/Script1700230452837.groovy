...
WebUI.callTestCase(findTestCase('EYM IO Login/Login Exemptax Sandbox'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.mouseOver(findTestObject('EYM IO - Connection Page/Exemptax/Exemptax Sandbox/Schylling-NetsuiteTokenBased Connection'))

WebUI.delay(2)

WebUI.click(findTestObject('EYM IO - Connection Page/Exemptax/Exemptax Sandbox/Schylling-NetsuiteTokenBased Connection'))
