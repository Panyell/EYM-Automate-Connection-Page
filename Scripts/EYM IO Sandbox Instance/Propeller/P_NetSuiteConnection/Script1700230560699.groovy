...
WebUI.mouseOver(findTestObject('EYM IO - Connection Page/Propeller/Propeller Sandbox/P_ NetSuiteTokenBased'))

WebUI.delay(2)

WebUI.click(findTestObject('EYM IO - Connection Page/Propeller/Propeller Sandbox/P_ NetSuiteTokenBased'))
